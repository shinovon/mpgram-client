...
public class InflaterHuffmanTree {
	 ...
	 */
	public InflaterHuffmanTree(byte[] codeLengths) throws Exception {
		buildTree(codeLengths);
	}

	private void buildTree(byte[] codeLengths) throws Exception {
		...
		if (code != 65536)
			throw new Exception("Data format: Code lengths don't add up properly.");

		/*
		 * Now create and fill the extra tables from longest to shortest bit len. This
		 * way the sub trees will be aligned.
		 */
	 ...
	 */
	public int getSymbol(StreamManipulator input) throws Exception {
