...
class InflaterDynHeader {
	...
	public boolean decode(StreamManipulator input) throws Exception {
		decode_loop: for (;;) {
			switch (mode) {
			case LNUM:
...
//  		  System.err.println("repeating zero");
					...
					if (ptr == 0)
						throw new Exception("Data format");
				}
				repSymbol = symbol - 16;
				mode = REPS;
			}
...
//  	      System.err.println("litdistLens repeated: "+count);
	...
	public InflaterHuffmanTree buildLitLenTree() throws Exception {
		byte[] litlenLens = new byte[lnum];
		System.arraycopy(litdistLens, 0, litlenLens, 0, lnum);
		return new InflaterHuffmanTree(litlenLens);
	}

	public InflaterHuffmanTree buildDistTree() throws Exception {
